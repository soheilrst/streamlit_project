...
page = st.sidebar.selectbox("Choose a page:", ["Home", "Data Quality & Visualisation", "Campaign and Mapping"])


if page == "Home":
    st.title("Welcome to the Home Page")
    st.write("""Hey there! Thanks for visiting my website. I'm excited to share some small but cool data analysis 
    ...
    st.info("Navigate using the sidebar to explore the Data Quality & Visualisation or the Campaign and Mapping sections.")
    ...
    st.write("This section provides tools to visualize campaign data on an interactive map.")
    st.markdown(
        """
        ### What You Can Do Here:
